...
const getEquiposLaboratorio = async (req, res = response) => {
    ...
    try {
        ...
        const equiposLaboratorio = await Laboratorio.find();
...
const registrarEquipoLaboratorio = async (req, res = response) => {
        ...
        try {
            ...
            const { codigo, nombre, modelo, marca, color, accesorios, condicion, cantidad, fecha_ingreso, descripcion, ubicacion, responsable, img, observaciones, fecha_anulacion, estado } = req.body;
