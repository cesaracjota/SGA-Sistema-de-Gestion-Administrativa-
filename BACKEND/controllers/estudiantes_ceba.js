...
const registrarEstudiante = async (req, res = response) => {
        ...
        try {
            ...
            const { nombres, apellidos, dni, sexo, correo, celular, domicilio, fecha_nacimiento, nombre_padres, celular_padres, correo_padres, colegio_procedencia, tipo_estudiante, modalidad, ubicacion_periferico, grado, img, estado } = req.body;
