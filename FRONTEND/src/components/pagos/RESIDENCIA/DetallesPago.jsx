...
const DetallesPago = ({ location }) => {
    ...
    const { pago, isLoading, isError, message } = useSelector((state) => state.pagos_residencia);
    ...
    return (
        <>
            <Box
                ...
                p={4}
            >
                <Stack spacing={4} direction="row" justifyContent="space-between" p={2}>
                    <HStack spacing={4} direction="row">
                        <Link to={'/residencia/pagos'}>
